...
import { Producto } from "../db/models/productos.model.js";
...
export const createProducto = async (req,res,next) => {
    ...
    try{
        ...
        const nuevoProducto = await Producto.create({nombre, descripcion, fabricante});
        responseAPI.data= nuevoProducto;
        responseAPI.msg = `Producto ' ${nombre} ' fabricado por ${fabricante}, creado con éxito`
